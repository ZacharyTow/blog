                ...
                <form>
                    <div class="form">
                        <p>
                            ...
                            <input  id="articleTitle" type="text" class="field size1" style="font-size: 20px;font-weight: bold" value="${blogArticle.articleTitle}" />
                        </p>
                        <p>
                            <span class="req">max 100 symbols</span>
                            <label>Content <span>(Required Field)</span></label>
                            <textarea id="articleContent" class="field size1" rows="10" cols="30">${blogArticle.articleContent}</textarea>
                        </p>
                        <p>
                            <label>Branch</label>
